...
const FALLBACK_SECTIONS: { heading: string; body: string }[] = [
  ...
  { heading: "3. Payment processing", body: "Payments are processed by Square. Potomac never stores your full card number; Square handles payment data directly under its own security and privacy standards." },
