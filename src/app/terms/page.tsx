...
const FALLBACK_SECTIONS: { heading: string; body: string }[] = [
  ...
  { heading: "3. Bookings and payments", body: "Short-term stays are charged in full at the time of booking; long-term leases follow the payment schedule agreed with the host. All payments are processed securely through Square. Prices, fees, and cancellation policies are shown clearly before you confirm a booking." },
