...
const FooterNav = () => {
  ...
  return (
    <nav
      ...
      className="FooterNav block md:!hidden p-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] bg-white dark:bg-neutral-800 fixed top-auto bottom-0 inset-x-0 z-30 border-t border-neutral-300 dark:border-neutral-700"
    >
